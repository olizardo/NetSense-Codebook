//WinterSurvey2013-Demographic Codes
set more off
label drop _all

insheet using "M:\JoeWorkmanWork\Winter 2013 Demographic Survey.csv", clear comma
...
//recode fall2012work
tab1 fall2012work
encode fall2012work, gen(fall2012workx)
label define fall2012work 1 "None" 2 "0-4" 3 "5-10" 4 "11-15" 5 "16-20" 6 "21 or more"
recode fall2012workx 1=2 2=4 3=3 4=1
label values fall2012workx fall2012work
order fall2012workx, after(fall2012work)
drop fall2012work
rename fall2012workx fall2012work
label variable fall2012work "Hours worked per week in 2nd semester of college"
tab1 fall2012work
...
tab1 activityfall2012*
foreach v of varlist activityfall20121-activityfall201214{
encode `v', gen(`v'x)
}
...
foreach v of varlist activityfall20121x-activityfall201214x {
recode `v' 1=2 2=3 3=4 4=1 5=0
label value `v' activities
}
tab1 activityfall20121x-activityfall201214x
order activityfall20121x-activityfall201214x, after(activityfall201214)
drop activityfall20121-activityfall201214
rename activityfall20121x activityfall20121
rename activityfall20122x activityfall20122
rename activityfall20123x activityfall20123 
rename activityfall20124x activityfall20124
rename activityfall20125x activityfall20125
rename activityfall20126x activityfall20126
rename activityfall20127x activityfall20127
rename activityfall20128x activityfall20128
rename activityfall20129x activityfall20129
rename activityfall201210x activityfall201210
rename activityfall201211x activityfall201211
rename activityfall201212x activityfall201212
rename activityfall201213x activityfall201213
rename activityfall201214x activityfall201214
 
label variable activityfall20121	"Attended a religious service"
label variable activityfall20122	"Demonstrated for a cause"
label variable activityfall20123	"Smoked a cigarette"
label variable activityfall20124	"Drank beer"
label variable activityfall20125	"Drank wine or liquor"
label variable activityfall20126	"Exercised"
label variable activityfall20127	"Felt overwhelmed by all I had to do"
label variable activityfall20128	"Felt depressed"
label variable activityfall20129	"Performed volunteer work"
label variable activityfall201210	"Socialized with someone of another racial/ethnic group"
label variable activityfall201211	"Discussed religion"
label variable activityfall201212	"Discussed politics"
label variable activityfall201213	"Worked on a local, state, or national political campaign"
label variable activityfall201213	"Publicly communicated my opinion about a cause (blog, email, petition)"

// Second semester Activity
tab1 fall2012hractivita-fall2012hractivitn
foreach v of varlist fall2012hractivita-fall2012hractivitn {
encode `v', gen(`v'1)
}
label define fall2012act 0 "None" 1 "Less than half an hour" 2 "1-2 hours" 3 "3-5 hours" 4 "6-10 hours" 5 "11-15 hours" 6 "16-20 hours" 7 "Over 20"
tab1 fall2012hractivita1
recode fall2012hractivita1 1=2 2=5 3=6 4=3 5=4 6=7
label value fall2012hractivita1 fall2012act

tab1 fall2012hractivitb1
recode fall2012hractivitb1 1=2 2=5 3=6 4=3 5=4 6=1 7=7
label value fall2012hractivitb1 fall2012act

tab1 fall2012hractivitc1 fall2012hractiviti1 fall2012hractivitm1 fall2012hractivitn1
foreach v of varlist fall2012hractivitc1 fall2012hractiviti1 fall2012hractivitm1 fall2012hractivitn1 {
recode `v' 1=2 2=5 3=6 4=3 5=4 6=1 7=0 8=7
label value `v' fall2012act
} 

tab1 fall2012hractivitd1 fall2012hractivitg1
foreach v of varlist fall2012hractivitd1 fall2012hractivitg1 {
recode `v' 1=2 2=5 3=6 4=3 5=4 6=1 7=0
label value `v' fall2012act
}

tab1 fall2012hractivite1 fall2012hractivitf1 fall2012hractivith1 fall2012hractivitk1
foreach v of varlist fall2012hractivite1 fall2012hractivitf1 fall2012hractivith1 fall2012hractivitk1  {
recode `v' 1=2 2=5 3=3 4=4 5=1 6=0
label value `v' fall2012act 
}

tab1 fall2012hractivitj1
recode fall2012hractivitj1 1=2 2=3 3=1 4=0
label value fall2012hractivitj1 fall2012act
 
tab1 fall2012hractivitl1
recode fall2012hractivitl1 1=2 2=5 3=3 4=4 5=1 6=0
label value fall2012hractivitl1 fall2012act

tab1 fall2012hractivita*
tab1 fall2012hractivitb*
tab1 fall2012hractivitc*
tab1 fall2012hractivitd*
tab1 fall2012hractivite*
tab1 fall2012hractivitf*
tab1 fall2012hractivitg*
tab1 fall2012hractivith*
tab1 fall2012hractiviti*
tab1 fall2012hractivitj*
tab1 fall2012hractivitk*
tab1 fall2012hractivitl*
tab1 fall2012hractivitm*
tab1 fall2012hractivitn*
order fall2012hractivita1-fall2012hractivitn1, after(fall2012hractivitn)
drop fall2012hractivita-fall2012hractivitn
rename fall2012hractivita1 timeperweekactivita
rename fall2012hractivitb1 timeperweekactivitb
rename fall2012hractivitc1 timeperweekactivitc
rename fall2012hractivitd1 timeperweekactivitd
rename fall2012hractivite1 timeperweekactivite
rename fall2012hractivitf1 timeperweekactivitf
rename fall2012hractivitg1 timeperweekactivitg
rename fall2012hractivith1 timeperweekactivith
rename fall2012hractiviti1 timeperweekactiviti
rename fall2012hractivitj1 timeperweekactivitj
rename fall2012hractivitk1 timeperweekactivitk
rename fall2012hractivitl1 timeperweekactivitl
rename fall2012hractivitm1 timeperweekactivitm
rename fall2012hractivitn1 timeperweekactivitn
...
*thosty is a double*
replace sender=5743671950 if netid=="901665925"
replace sender=5745406529 if netid=="emitche6"
replace sender=5745406529 if netid=="emitche6 "
*emitche6 is a double*
replace sender=5745407567 if netid=="xlin3"
replace sender=5745407528 if netid=="mmahan"
replace sender=5743671793 if netid=="cshort1"
replace sender=5745406425 if netid=="901704470"
replace sender=5745403836 if netid=="lfiranek"
...
order completed_5 FirstName_5 LastName_5 duplicate id_5
sort duplicate sender id_5
edit 

replace duplicate=2 if id_5==108
replace duplicate=2 if id_5==80
replace duplicate=2 if id_5==17
replace duplicate=2 if id_5==105
replace duplicate=2 if id_5==107
replace duplicate=2 if id_5==112
replace duplicate=2 if id_5==31
replace duplicate=2 if id_5==149
replace duplicate=2 if id_5==153
replace duplicate=2 if id_5==43
replace duplicate=2 if id_5==23
* Both surveys for Mengtian Zhao are pretty sparse *
replace duplicate=1 if id_5==127
replace duplicate=1 if id_5==116
* Two surveys 25 & 116 are both completed for Andrew Kimball; I designated the first to be dropped *
replace duplicate=1 if id_5==27


*** Renaming Certain Stubs to Match Surveys 1-3 ***

rename fall2012work_5 semwork_5

rename thirdsemclasses1_5 semclasses1_5
rename thirdsemclasses2_5 semclasses2_5
rename thirdsemclasses3_5 semclasses3_5
rename thirdsemclasses4_5 semclasses4_5
rename thirdsemclasses5_5 semclasses5_5
rename thirdsemclasses6_5 semclasses6_5
rename thirdsemclasses7_5 semclasses7_5

rename activityfall20121_5 activity1_5
rename activityfall20122_5 activity2_5
rename activityfall20123_5 activity3_5
rename activityfall20124_5 activity4_5
rename activityfall20125_5 activity5_5
rename activityfall20126_5 activity6_5
rename activityfall20127_5 activity7_5
rename activityfall20128_5 activity8_5
rename activityfall20129_5 activity9_5
rename activityfall201210_5 activity10_5
rename activityfall201211_5 activity11_5
rename activityfall201212_5 activity12_5
rename activityfall201213_5 activity13_5
rename activityfall201214_5 activity14_5

rename timeperweekactivita_5 timeperweekactivea_5
rename timeperweekactivitb_5 timeperweekactiveb_5
rename timeperweekactivitc_5 timeperweekactivec_5
rename timeperweekactivitd_5 timeperweekactived_5
rename timeperweekactivite_5 timeperweekactivee_5
rename timeperweekactivitf_5 timeperweekactivef_5
rename timeperweekactivitg_5 timeperweekactiveg_5
rename timeperweekactivith_5 timeperweekactiveh_5
rename timeperweekactiviti_5 timeperweekactivei_5
rename timeperweekactivitj_5 timeperweekactivej_5
rename timeperweekactivitk_5 timeperweekactivek_5
rename timeperweekactivitl_5 timeperweekactivel_5
rename timeperweekactivitm_5 timeperweekactivem_5
rename timeperweekactivitn_5 timeperweekactiven_5



rename extraversion extraversion_5
rename agreeableness agreeableness_5
rename conscientiousness conscientiousness_5
rename neuroticism neuroticism_5
rename openness openness_5

rename homosexual1_5 homosexual_5
rename premaritalsex1_5 premaritalsex_5
rename fswelfare1_5 fswelfare_5
rename fssocsec1_5 fssocsec_5
rename lesseq1_5 lesseq_5
rename toomucheqrights1_5 toomucheqrights_5
rename eqchances1_5 eqchances_5


save "M:\JoeWorkmanWork\Demographic Surveys\Winter 2013(W5) - Demographic Survey - 2014_01_31.dta", replace


What About Third Sem Classes 1-7?
  Perhaps the survey I am working off does not ask about classes because of time of year. Look in other surveys or adapt from other variables
  
// first sem classes are open ended, and we need to determine what to do with those that are not all numerical before coding them
  *From Summer Survey 2012 Margaret
